...
set key at 3, 114 samplen 2 spacing 0.95 font ", 34" maxrows 2;
set mytics 5
set grid ytics;
...
# Accuracy
# set ylabel 'Accuracy [%]';
# set output 'image_new/histogram/FlatVsHierarchicalEarlyAccuracy.eps';
# plot 'data_wnb/metrics/join_fp/optimal_early_bar.dat' using ($2*100):(($2-$6*3)*100):(($2+$6*3)*100):xtic(1) ls 30 fs pattern 6 title 'Flat L1',\
...
#      '' using ($32*100):(($32-$36*3)*100):(($32+$36*3)*100) ls 60 fs pattern 3 title 'Hierarchical',\

# # F-measure
# set output 'image_new/histogram/FlatVsHierarchicalEarlyFMeasure.eps';
# set ylabel 'F-measure [%]';
# plot 'data_wnb/metrics/join_fp/optimal_early_bar.dat' using ($3*100):(($3-$7*3)*100):(($3+$7*3)*100):xtic(1) ls 30 fs pattern 6 title 'Flat L1',\
...
#      '' using ($33*100):(($33-$37*3)*100):(($33+$37*3)*100) ls 60 fs pattern 3 title 'Hierarchical',\

# # G-mean
# set output 'image_new/histogram/FlatVsHierarchicalEarlyGmean.eps';
# set ylabel 'G-mean [%]';
# plot 'data_wnb/metrics/join_fp/optimal_early_bar.dat' using ($5*100):(($5-$9*3)*100):(($5+$9*3)*100):xtic(1) ls 30 fs pattern 6 title 'Flat L1',\
...
#      '' using ($35*100):(($35-$39*3)*100):(($35+$39*3)*100) ls 60 fs pattern 3 title 'Hierarchical',\

# Accuracy
set ylabel 'Accuracy [%]';
set output 'image_new/histogram/FlatVsHierarchicalEarlyAccuracy.eps';
plot 'data_new/optimal_early_bar.dat' using ($2*100):(($2-$6*3)*100):(($2+$6*3)*100):xtic(1) ls 30 fs pattern 6 title 'Flat',\
...
set output 'image_new/histogram/FlatVsHierarchicalEarlyFMeasure.eps';
set ylabel 'F-measure [%]';
plot 'data_new/optimal_early_bar.dat' using ($3*100):(($3-$7*3)*100):(($3+$7*3)*100):xtic(1) ls 30 fs pattern 6 title 'Flat',\
...
set output 'image_new/histogram/FlatVsHierarchicalEarlyGmean.eps';
set ylabel 'G-mean [%]';
plot 'data_new/optimal_early_bar.dat' using ($5*100):(($5-$9*3)*100):(($5+$9*3)*100):xtic(1) ls 30 fs pattern 6 title 'Flat',\
